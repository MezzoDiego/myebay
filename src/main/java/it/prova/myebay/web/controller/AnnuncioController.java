...
public class AnnuncioController {
	...
	public String listAnnunci(Annuncio annuncioExample, ModelMap model) {
		...
		model.addAttribute("annunci_list_attribute",
				AnnuncioDTO.createAnnuncioDTOFromModelList(annuncioService.findByExample(annuncioExample), false, false));
	...
	public String showAnnuncio(HttpServletRequest request, @PathVariable(required = true) Long idAnnuncio, Model model) {
		Annuncio annuncioModel = annuncioService.caricaSingoloElementoConCategorie(idAnnuncio);
	...
	public String listAnnunciUtente(HttpServletRequest request, Annuncio annuncioExample, ModelMap model) {
		...
		model.addAttribute("annunci_list_attribute",
				AnnuncioDTO.createAnnuncioDTOFromModelList(annuncioService.findByExampleEager(annuncioExample), true, false));
