			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="reset_utente_attr" method="post" action="${pageContext.request.contextPath}/account/applyReset" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-3">
									...
									<spring:bind path="vecchiaPassword">
										<input type="password" class="form-control ${status.error ? 'is-invalid' : ''}" name="vecchiaPassword" id="vecchiaPassword" placeholder="Inserire la vecchia password"  required>
									</spring:bind>
								...
								<div class="col-md-3">
									...
									<spring:bind path="nuovaPassword">
										<input type="password" class="form-control ${status.error ? 'is-invalid' : ''}" name="nuovaPassword" id="nuovaPassword" placeholder="Inserire la nuova password"  required>
									</spring:bind>
